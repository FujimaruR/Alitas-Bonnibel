...
import { FavoriteCard } from "../components/public/FavoriteCard";
...
const DESTACADOS = [
    {
        title: "Combo 12 Alitas",
        description: "Elige hasta 2 sabores, papas gajo y aderezo.",
        price: 189,
        tag: "Más pedido",
        imageUrl:
    ...
    {
        title: "Boneless Lovers",
        description: "300g de boneless + papas a la francesa.",
        price: 169,
        tag: "Recomendado",
        imageUrl:
    ...
    },
    {
        ...
        description: "24 alitas, 300g de boneless, papas y aderezos.",
        price: 349,
        tag: "Para compartir",
        imageUrl:
                ...
                <div className="max-w-6xl mx-auto px-4 py-14 md:py-20 grid md:grid-cols-2 gap-10 items-center">
                    ...
                    <div>
                        ...
                        <div className="flex flex-wrap gap-3 items-center">
                            ...
                            <button className="px-4 py-2.5 rounded-full bg-white/90 text-slate-900 text-sm font-semibold border border-white/60 hover:bg-white transition">
                                Pide para llevar
                            </button>
                    ...
                    {/* “Foto” / highlight (por ahora, bloque ilustrativo) */}
                    <div
                        className="
                            animate-slide-up
                    ...
                    >
                        {/* overlay oscuro tipo “banner promo” */}
                ...
                <div className="max-w-6xl mx-auto px-4 py-12 md:py-16">
                    ...
                    <div className="grid md:grid-cols-3 gap-5">
                        {DESTACADOS.map((item, i) => (
                            <Reveal key={item.title} delayMs={i * 180}>
